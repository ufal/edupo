...
const AUTHOR_STYLE_TO_BACKEND = {
  ...
  neruda: 'Neruda, Jan',
  halek: 'Hálek, Vítězslav',
  brezina: 'Březina, Otokar',
  karasek: 'Karásek ze Lvovic, Jiří',
  hlavacek: 'Hlaváček, Karel',
  gellner: 'Gellner, František',
  wolker: 'Wolker, Jiří',
  nezval: 'Nezval, Vítězslav',
  seifert: 'Seifert, Jaroslav',
  biebl: 'Biebl, Konstantin',
  holan: 'Holan, Vladimír',
  bondy: 'Bondy, Egon',
  reynek: 'Reynek, Bohuslav',
  divis: 'Diviš, Ivan',
  krchovsky: 'Krchovský, J. H.',
  hruska: 'Hruška, Petr',
  spravcova: 'Správcová, Božena',
  stehlikova: 'Stehlíková, Olga',
  rudcenkova: 'Rudčenková, Kateřina',
  maly: 'Malý, Radek',
  borkovec: 'Borkovec, Petr',
  iljasenko: 'Iljašenko, Marie',
  tesnohlidek: 'Těsnohlídek, Jan',
  jirous: 'Jirous, Ivan Martin',
  wernisch: 'Wernisch, Ivan',
  fischerova: 'Fischerová, Viola',
  hrabe: 'Hrabě, Václav'
} as const
