...
export default {
	...
	theme: {
		extend: {
			...
			colors: {
				...
				lime200Transparent: 'var(--lime-200-transparent)',
				...
				violet200Transparent: 'var(--violet-200-transparent)',
				violet300: 'var(--violet-300)',
				violet600: 'var(--violet-600)',
				crimson200: 'var(--crimson-200)',
				crimson200Transparent: 'var(--crimson-200-transparent)',
				crimson300: 'var(--crimson-300)',
				crimson600: 'var(--crimson-600)',
	...
	safelist: [
		...
		'bg-violet200', 'bg-violet200Transparent', 'bg-violet300', 'text-violet600',
		'bg-teal200', 'bg-teal200Transparent', 'bg-teal300', 'text-teal600',
		'bg-lime200', 'bg-lime200Transparent', 'bg-lime300', 'text-lime600',
		'bg-sky200', 'bg-sky200Transparent', 'bg-sky300', 'text-sky600',
		'bg-yellow200', 'bg-yellow200Transparent', 'bg-yellow300', 'text-yellow600',
		'bg-crimson200', 'bg-crimson200Transparent', 'bg-crimson300', 'text-crimson600',
		'slate200Transparent'
	  ],
